...
// src/utils/log/wechat.ts
var import_axios2 = __toESM(require_axios2());
var WechatService = class extends LogService {
  constructor() {
    super();
  ...
  sendMessage(content) {
    return __async(this, null, function* () {
      ...
      const response = yield import_axios2.default.post(url, {
        msgtype: "markdown",
        markdown: {
...
var wechat_default = new WechatService();

// src/utils/log/index.ts
var services = [email_default, wechat_default];
